...
export default function AccountPopover() {
  ...
  const handleLogout = () => {
    handleClose();
    dispatch({ type: 'UPDATE_USER_DATA', user_data: { accessToken: '' } });
  ...
  const UserEmail = state.user_data.userEmail
  ...
  return (
    <>
      ...
      >
        ...
        >
          {employeFirstName.charAt(0).toUpperCase()}
        </Avatar>
      </IconButton>
