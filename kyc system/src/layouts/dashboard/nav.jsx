...
export default function Nav({ openNav, onCloseNav }) {
  ...
  useEffect(() => {
    ...
    if (user_data && user_data.staffRole) {
      sessionStorage.setItem("currentRole", user_data.staffRole[0]);
    }
  ...
  // useEffect(() => {
  //   if (sessionStorage.getItem('data_entry') && sessionStorage.getItem('approver')) {
  //     sessionStorage.setItem('currentRole', 'data_entry');
